...
- (void)loadImage {
    ...
    // 开始加载
    weak_self;
    self.opreation =[[SDWebImageManager sharedManager] downloadImageWithURL:self.url options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
